...
{
    public class Detalle_RecepcionPlacas_TransporteRecibeVM
    {
        ...
        public static Detalle_RecepcionPlacas_TransporteRecibeVM operator +(Detalle_RecepcionPlacas_TransporteRecibeVM placas_TransporteEnvioVM, TransferenciaPlacas_Transporte _TransporteEnvio)
        {
