...
{
    public class Detalle_TransferenciaPlacas_DatosPersonaEnvioVM
    {
        ...
        public static Detalle_TransferenciaPlacas_DatosPersonaEnvioVM operator +(Detalle_TransferenciaPlacas_DatosPersonaEnvioVM placas_DatosPersonaEnvioVM, TransferenciaPlacas_DatosPersona _DatosPersonaEnvio)
        {
