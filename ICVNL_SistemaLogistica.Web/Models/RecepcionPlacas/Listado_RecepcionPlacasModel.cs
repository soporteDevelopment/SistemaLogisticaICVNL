...
{
    public class Listado_RecepcionPlacasModel
    {
        ...
        public static Listado_RecepcionPlacasModel operator +(Listado_RecepcionPlacasModel transferenciaPlacasM, TransferenciaPlacas transferenciaPlacas)
        {
